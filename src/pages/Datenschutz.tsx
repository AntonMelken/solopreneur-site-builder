    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground space-y-6">
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">2. Allgemeines zur Datenverarbeitung</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">4. Kontaktformular</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">5. Cookies und lokale Speicherung</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">6. Keine Analyse-Tools, kein Tracking</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">7. Externe Links</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground">8. Ihre Rechte als betroffene Person</h2>
            ...
            <p>Zuständige Aufsichtsbehörde ist der Landesbeauftragte für den Datenschutz und die Informationsfreiheit Ihres Bundeslandes.</p>
          </section>
          <section>
            <h2 className="text-lg font-bold text-foreground">9. Aktualität dieser Erklärung</h2>
            <p>Stand: März 2026.</p>
          </section>
        </div>
      </div>
