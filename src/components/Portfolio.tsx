...
const projects: {
...
}[] = [
  {
    ...
    description:
      "GPS-basierter Fahrassistent mit farbkodiertem Echtzeit-Tracking und einem mehrdimensionalen Driving Score. Inkl. Kraftstoffanalyse, Smart-Fahrtipps sowie einem durchdachten Freemium-Monetarisierungsmodell. Gehostet auf EU-Servern.",
...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-20 sm:py-28 px-6" style={{ background: "linear-gradient(180deg, transparent, hsla(211,100%,44%,0.025) 50%, transparent)" }}>
